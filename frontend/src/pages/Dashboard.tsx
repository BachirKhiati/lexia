      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-10 flex items-start justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-3 bg-lexia-surface hover:bg-lexia-surface-hover border-2 border-lexia-border hover:border-lexia-primary rounded-xl transition-all duration-300 text-lexia-text font-semibold shadow-md hover:shadow-glow-sm group"
            title="Restart Tour"
          >
          ...
          {modules.map((module) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl font-bold mb-3 text-lexia-text group-hover:bg-gradient-to-r group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300" style={{
                ...
                <p className="text-lexia-text-secondary leading-relaxed">
                  {module.description}
                </p>
              </div>
            </Link>
        ...
        <div className="card bg-gradient-to-br from-lexia-primary/10 via-lexia-accent/10 to-lexia-secondary/10 border-2 border-lexia-primary/30 shadow-elegant">
          <div className="flex items-center gap-3 mb-6">
            <Sparkles className="w-8 h-8 text-lexia-primary" />
            <h2 className="text-3xl font-bold text-lexia-text">The Complete Learning Cycle</h2>
          </div>
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-4 bg-lexia-surface rounded-xl border border-lexia-border hover:border-lexia-info transition-all duration-300 group">
              <span className="text-4xl transform group-hover:scale-110 transition-transform">🌍</span>
              <span className="text-lexia-text">
                <strong className="font-bold text-lexia-info">Discover:</strong> Read articles with The Lens and find new words
              </span>
            </div>
            <div className="flex items-center gap-4 p-4 bg-lexia-surface rounded-xl border border-lexia-border hover:border-lexia-secondary transition-all duration-300 group">
              <span className="text-4xl transform group-hover:scale-110 transition-transform">🧠</span>
              <span className="text-lexia-text">
                <strong className="font-bold text-lexia-secondary">Capture:</strong> Add words to your knowledge graph as "ghost nodes"
              </span>
            </div>
            <div className="flex items-center gap-4 p-4 bg-lexia-surface rounded-xl border border-lexia-border hover:border-lexia-primary transition-all duration-300 group">
              <span className="text-4xl transform group-hover:scale-110 transition-transform">✍️</span>
              <span className="text-lexia-text">
                <strong className="font-bold text-lexia-primary">Practice:</strong> Complete quests to master your ghost words
              </span>
            </div>
            <div className="flex items-center gap-4 p-4 bg-lexia-surface rounded-xl border border-lexia-border hover:border-lexia-success transition-all duration-300 group">
              <span className="text-4xl transform group-hover:scale-110 transition-transform">✨</span>
              <span className="text-lexia-text">
                <strong className="font-bold text-lexia-success">Master:</strong> Watch ghost nodes become solid as you learn
              </span>
            </div>
            <div className="flex items-center gap-4 p-4 bg-lexia-surface rounded-xl border border-lexia-border hover:border-lexia-accent transition-all duration-300 group">
              <span className="text-4xl transform group-hover:scale-110 transition-transform">🗣️</span>
              <span className="text-lexia-text">
