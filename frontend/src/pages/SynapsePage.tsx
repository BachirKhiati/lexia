  ...
  return (
    <div className="h-screen flex flex-col p-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-xl text-lexia-text-secondary mb-4">
          Your personal knowledge graph. Watch your language network grow!
        </p>

        {/* Stats */}
        <div className="flex gap-4">
          <div className="bg-lexia-surface px-4 py-2 rounded-lg">
            <span className="text-lexia-text-secondary">Total Words:</span>
            <span className="ml-2 font-bold text-lexia-text">{stats.total}</span>
          </div>
          <div className="bg-lexia-surface px-4 py-2 rounded-lg">
            <span className="text-lexia-text-secondary">Mastered:</span>
            <span className="ml-2 font-bold text-synapse-solid">{stats.solid}</span>
          </div>
          <div className="bg-lexia-surface px-4 py-2 rounded-lg">
            <span className="text-lexia-text-secondary">Learning:</span>
        ...
        {isLoading ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-lexia-background rounded-xl">
            <div className="text-center">
              ...
              <p className="text-lexia-text-secondary mb-4">
